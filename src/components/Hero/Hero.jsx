...
const Hero = () => {
    return (
        // <div className='container'>
            <div className="hero bg-base-200  min-h-screen w-full overflow-hidden">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='sm:w-full md:w-1/2'>
                        <h1 className="leading-tight text-4xl sm:text-5xl lg:text-6xl tracking-normal font-black hero-text lg:leading-tight md:leading-6 ">
